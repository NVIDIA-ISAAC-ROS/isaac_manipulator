...
from isaac_ros_manipulation_ros_python_utils.config import CoreConfig, UrRobotiqDriverConfig
...
def get_moveit_group_node(driver_config: UrRobotiqDriverConfig) -> Tuple[Node, Dict]:
    ...
    moveit_config = (
        MoveItConfigsBuilder(
            'ur_with_gripper', package_name='isaac_ros_manipulation_robot_description')
...
def get_ros2_control_nodes_for_sim(driver_config: UrRobotiqDriverConfig) -> List[Node]:
    ...
    gripper_controller = Node(
        package='isaac_ros_manipulation_isaac_sim_utils',
...
def get_ros2_control_nodes_for_real(driver_config: UrRobotiqDriverConfig) -> List[Node]:
    ...
    initial_joint_controllers = PathJoinSubstitution(
        [FindPackageShare('isaac_ros_manipulation_robot_description'),
         'config', 'ros2_control_controllers.yaml']
    )

    robotiq_gripper_controllers = PathJoinSubstitution(
        [FindPackageShare('isaac_ros_manipulation_robot_description'), 'config',
