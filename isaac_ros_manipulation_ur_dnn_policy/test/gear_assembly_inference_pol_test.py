...
from isaac_ros_manipulation_interfaces.action import Insert
import isaac_ros_manipulation_ros_python_utils as manipulator_utils
...
def generate_test_description():
    ...
    isaac_ros_manipulation_ur_dnn_policy_include_dir = os.path.join(
    ...
    test_nodes.append(IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [isaac_ros_manipulation_ur_dnn_policy_include_dir, '/gear_assembly.launch.py']),
