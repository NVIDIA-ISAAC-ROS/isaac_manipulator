...
from isaac_ros_manipulation_ur_dnn_policy.msg import Inference
import numpy as np
            ...
            if key in ('arm_dof_pos'):
                ...
                if not self.ood_detector.target_rotation_in_distribution(rotation):
                    self.get_logger().warning(f'Target rotation out of distribution, rotation'
                                              ...
                                              f'Rotation lower bound: {self.target_rot_lower} and'
                                              f'Rotation upper bound: {self.target_rot_upper}')
