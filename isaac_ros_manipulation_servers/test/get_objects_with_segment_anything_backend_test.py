...
from isaac_ros_manipulation_interfaces.action import AddSegmentationMask, GetObjectPose, GetObjects
from isaac_ros_manipulation_interfaces.srv import AddMeshToObject
...
def generate_test_description():
    object_info_node = ComposableNode(
        ...
        package='isaac_ros_manipulation_servers',
