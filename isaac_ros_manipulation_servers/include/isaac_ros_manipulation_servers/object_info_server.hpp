...
#ifndef ISAAC_ROS_MANIPULATION_SERVERS__OBJECT_INFO_SERVER_HPP_
#define ISAAC_ROS_MANIPULATION_SERVERS__OBJECT_INFO_SERVER_HPP_
...
#include "isaac_ros_manipulation_interfaces/action/add_segmentation_mask.hpp"
#include "isaac_ros_manipulation_interfaces/action/detect_objects.hpp"
#include "isaac_ros_manipulation_interfaces/action/estimate_pose_dope.hpp"
#include "isaac_ros_manipulation_interfaces/action/estimate_pose_foundation_pose.hpp"
#include "isaac_ros_manipulation_interfaces/action/get_objects.hpp"
#include "isaac_ros_manipulation_interfaces/action/get_object_pose.hpp"
#include "isaac_ros_manipulation_interfaces/action/segment_anything.hpp"
#include "isaac_ros_manipulation_interfaces/srv/add_mesh_to_object.hpp"
#include "isaac_ros_manipulation_interfaces/srv/assign_name_to_object.hpp"
#include "isaac_ros_manipulation_interfaces/srv/clear_objects.hpp"
#include "isaac_ros_manipulation_servers/impl/action_clients.hpp"
#include "isaac_ros_manipulation_servers/impl/action_client_manager.hpp"
#include "isaac_ros_manipulation_servers/impl/backend_manager.hpp"
...
using GetObjectPoseAction = isaac_ros_manipulation_interfaces::action::GetObjectPose;
using GetObjectsAction = isaac_ros_manipulation_interfaces::action::GetObjects;
using AddSegmentationMaskAction = isaac_ros_manipulation_interfaces::action::AddSegmentationMask;

using AddMeshToObjectSrv = isaac_ros_manipulation_interfaces::srv::AddMeshToObject;
using ClearObjectsSrv = isaac_ros_manipulation_interfaces::srv::ClearObjects;
using AssignNameToObjectSrv = isaac_ros_manipulation_interfaces::srv::AssignNameToObject;
...
private:
  ...
  std::unordered_map<int, isaac_ros_manipulation_interfaces::msg::ObjectInfo> objects_;
...
#endif  // ISAAC_ROS_MANIPULATION_SERVERS__OBJECT_INFO_SERVER_HPP_
