...
from isaac_manipulator_ros_python_utils.test_utils import DriverTest
...
def generate_test_description():
    """Verify nvblox disabling functionality with RealSense camera."""
    ...
    if RUN_TEST:
        ...
        test_nodes.append(IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [isaac_manipulator_workflow_bringup_include_dir, '/ur_robotiq_driver.launch.py']),
