...
OUTPUT_DIR = os.environ.get('OUTPUT_DIR', f'{ISAAC_ROS_WS}/realsense_pose')
RECORD_ROSBAG = os.environ.get('ISAAC_MANIPULATOR_TEST_RECORD_ROSBAG', 'false').lower() == 'true'
