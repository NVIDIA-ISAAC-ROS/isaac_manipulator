...
from isaac_ros_manipulation_orchestration.behaviors.perception_behaviors.detect_object import (
    DetectObject
)
...
def generate_test_description():
    ...
    test_include_dir = os.path.join(
        get_package_share_directory('isaac_ros_manipulation_orchestration'),
        'test', 'include'
    )
