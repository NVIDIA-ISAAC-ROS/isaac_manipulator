...
from isaac_ros_manipulation_orchestration.behaviors.motion_behaviors.motion_utils import (
...
class AttachObject(BaseActionBehavior):
    ...
    def _trigger_attach_object(self, object_class_id: str, mesh_file_path: str):
        ...
        # Get the object's pose expressed in grasp_frame. This retrieves pre-recorded
        # gripper poses w.r.t. object frame from file, selects one by index, composes
        # it with the gripper_frame->grasp_frame transform, and inverts the result
        # to obtain the object pose in grasp_frame coordinates.
        ...
        # Convert to dictionary format (object pose in grasp_frame)
        grasp_pose_object_dict = {
            'position': [
