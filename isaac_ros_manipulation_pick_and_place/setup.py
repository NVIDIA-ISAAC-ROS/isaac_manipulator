...
setup(
    ...
    description='Reference example package for Isaac Manipulator Pick and Place',
    license='Apache-2.0',
    extras_require={
        'test': [
            'pytest'
    ...
    entry_points={
        'console_scripts': [
            ...
            'isaac_ros_manipulation_pick_and_place.scripts.multi_object_pick_and_place:main',
        ],
    },
)
