...
from isaac_ros_manipulation_ros_python_utils.perception import create_camera_drop_node
...
def add_realsense_drivers(args: lu.ArgumentContainer) -> List[Action]:
    ...
    realsense_config = lu.get_path(
        'isaac_ros_manipulation_bringup', 'config/sensors/realsense.yaml')
    ...
    unspecified_ids_config_path = lu.get_path(
        'isaac_ros_manipulation_bringup', 'config/sensors/realsense_camera_ids/unspecified.yaml')
