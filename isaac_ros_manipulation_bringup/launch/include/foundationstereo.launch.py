...
def launch_setup(context, *args, **kwargs):
    ...
    depth_type_str = str(
        context.perform_substitution(LaunchConfiguration('depth_type'))).upper()
    depth_type = DepthType[depth_type_str]
    model_width, model_height = get_dnn_stereo_depth_resolution(depth_type)
...
def generate_launch_description():
    launch_args = [
        ...
        DeclareLaunchArgument(
            ...
            description='Absolute path to the FoundationStereo engine plan.'),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            'depth_type',
            default_value=str(DepthType.FOUNDATION_STEREO_LOW_RES),
            choices=[str(DepthType.FOUNDATION_STEREO_LOW_RES),
                     str(DepthType.FOUNDATION_STEREO_HIGH_RES)],
            description='Depth estimation type. Choose between '
                        'FOUNDATION_STEREO_LOW_RES, FOUNDATION_STEREO_HIGH_RES'),
    ]
