...
"""Tests the correctness of the robot segmentor for Realsense with ESS setup."""
...
OUTPUT_DIR = os.path.join(ISAAC_ROS_WS, 'robot_segmentor_pol_realsense_ess_test')
