...
"""Tests if object detection is working correctly for the Isaac Sim platform."""
...
from isaac_ros_manipulation_ros_python_utils.test_utils import (
    IsaacROSFoundationPoseEstimationPolTest
)
...
def generate_test_description():
    ...
    return IsaacROSFoundationPoseEstimationPolTest.generate_test_description(
        ...
        max_latency_time=0.3,
        num_messages_to_receive=20,
        num_warmup_messages=5,
        use_sim_time=True,
