...
"""Smoke test Flexiv cuMotion planning with nvblox and robot segmenter enabled."""
...
def generate_test_description():
    """Launch Flexiv driver, Realsense, nvblox, robot segmenter, and cuMotion."""
...
class FlexivMotionPlanWithNvbloxTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        if not RUN_TEST:
            return
        rclpy.init()
        cls.node = rclpy.create_node('flexiv_motion_plan_with_nvblox_test')
    ...
    def _wait_for_arm_joint_state(self, timeout_sec=10.0):
