...
from isaac_ros_manipulation_ros_python_utils.test_utils import (
    IsaacRosManipulationGearAssemblyPolTest
)
...
OUTPUT_DIR = f'/{ISAAC_ROS_WS}/manipulator_gear_assembly_test_realsense'
...
def generate_test_description():
    ...
    IsaacRosManipulationGearAssemblyPolTest.generate_namespace()
    ...
    return IsaacRosManipulationGearAssemblyPolTest.generate_test_description(
        run_test=RUN_TEST,
        nodes=test_nodes,
