...
"""
Tests the entire stack on pose estimation run using Realsense + FoundationStereo.
...
OUTPUT_DIR = os.environ.get('OUTPUT_DIR', f'{ISAAC_ROS_WS}/foundationstereo_pose')
...
def generate_test_description():
    ...
    override_params = {
        ...
        'depth_type': 'FOUNDATION_STEREO_LOW_RES',
    ...
    return PoseEstimationServersPolTest.generate_test_description(
        ...
        identifier='foundationstereo_pose',
    )
