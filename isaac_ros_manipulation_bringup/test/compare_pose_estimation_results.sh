...
launch_test $ISAAC_ROS_WS/src/isaac_ros_manipulation/isaac_ros_manipulation_bringup/test/pick_and_place_servers_realsense_with_foundationstereo_test.py

export OUTPUT_DIR=$ISAAC_ROS_WS/ess_pose_test

launch_test $ISAAC_ROS_WS/src/isaac_ros_manipulation/isaac_ros_manipulation_bringup/test/pick_and_place_servers_realsense_with_ess_test.py

export OUTPUT_DIR=$ISAAC_ROS_WS/realsense_pose_test

launch_test $ISAAC_ROS_WS/src/isaac_ros_manipulation/isaac_ros_manipulation_bringup/test/pick_and_place_servers_realsense_pol_test.py
...
launch_test $ISAAC_ROS_WS/src/isaac_ros_manipulation/isaac_ros_manipulation_bringup/test/pose_differences_depth_backend_test.py
