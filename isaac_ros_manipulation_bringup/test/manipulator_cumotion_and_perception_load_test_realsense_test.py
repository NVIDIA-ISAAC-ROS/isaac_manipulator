...
from isaac_ros_manipulation_ros_python_utils.test_utils import \
    IsaacRosManipulationLoadEstimationTest
...
OUTPUT_DIR = f'/{ISAAC_ROS_WS}/manipulator_load_test_realsense'


@pytest.mark.rostest
def generate_test_description():
    """Generate launch description with Cumotion, perception and nvblox nodes for testing."""
    IsaacRosManipulationLoadEstimationTest.generate_namespace()
    ...
    return IsaacRosManipulationLoadEstimationTest.generate_test_description(
        run_test=RUN_TEST,
        nodes=test_nodes,
