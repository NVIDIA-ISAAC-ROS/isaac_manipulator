...
from isaac_ros_manipulation_ros_python_utils.test_utils import (
    IsaacRosManipulationSegmentAnythingPolTest
)
...
def generate_test_description():
    ...
    IsaacRosManipulationSegmentAnythingPolTest.generate_namespace()
    ...
    return IsaacRosManipulationSegmentAnythingPolTest.generate_test_description(
        run_test=RUN_TEST,
        nodes=test_nodes,
