...
from isaac_ros_manipulation_ros_python_utils.test_utils import (
    IsaacRosManipulationPoseEstimationErrorPolTest
)
...
def generate_test_description():
    ...
    IsaacRosManipulationPoseEstimationErrorPolTest.generate_namespace()
    ...
    return IsaacRosManipulationPoseEstimationErrorPolTest.generate_test_description(
        run_test=RUN_TEST,
        nodes=test_nodes,
