...
"""Tests the entire stack with SAM, RT-DETR, and Foundation Pose using Isaac Sim."""
...
from isaac_ros_manipulation_ros_python_utils.test_utils import (
    IsaacRosManipulationServersPolTest
)
...
OUTPUT_DIR = os.path.join(
    ISAAC_ROS_WS,
    'segment_anything_rtdetr_detector_servers_sim_test')


@pytest.mark.rostest
def generate_test_description():
    """Generate launch description with Foundation Pose nodes for testing."""
    IsaacRosManipulationServersPolTest.generate_namespace()
    ...
    return IsaacRosManipulationServersPolTest.generate_test_description(
        run_test=RUN_TEST,
        nodes=test_nodes,
