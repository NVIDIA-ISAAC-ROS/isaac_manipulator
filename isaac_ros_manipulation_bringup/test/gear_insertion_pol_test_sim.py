...
from isaac_ros_manipulation_ros_python_utils.test_utils import \
    IsaacRosManipulationGearInsertionPolTest
...
def generate_test_description():
    ...
    IsaacRosManipulationGearInsertionPolTest.generate_namespace()
    ...
    if RUN_TEST:
        ...
        test_nodes.append(IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [isaac_ros_manipulation_test_bringup_include_dir,
    ...
    return IsaacRosManipulationGearInsertionPolTest.generate_test_description(
        run_test=RUN_TEST,
        nodes=test_nodes,
